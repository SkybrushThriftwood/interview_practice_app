...
4. Include tools for tracing, logging, monitoring relevant metrics and SLOs.
5. Add a vector database to check if the provided interview preparation data was seen before, prompting LLM to generate new interview preparation data.
6. Use open-source LLMs (not Gemini, OpenAI, etc.) for the project.
7. [Fine-tune](https://platform.openai.com/docs/guides/fine-tuning) an LLM to have an interview preparation focus.
